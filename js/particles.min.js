...
particlesJS("particles-js", {
    particles: {
        ...
        color: { value: "#ffffff" },
        shape: { type: "polygon", stroke: { width: 0, color: "#ffffff" }, polygon: { nb_sides: 3 }, image: { src: "../img/no-img.png", width: 100, height: 100 } },
        opacity: { value: 0.3, random: true, anim: { enable: false, speed: 1, opacity_min: 0.2, sync: false } },
        size: { value: 5, random: true, anim: { enable: false, speed: 40, size_min: 0.1, sync: false } },
        line_linked: { enable: true, distance: 150, color: "#ffffff", opacity: 0.07, width: 1 },
